...
def main():
    ...
    eventsResult = service.events().list(
        calendarId='iborukhovich@remedypartners.com', timeMin=now, maxResults=10, singleEvents=True,
    ...
    for event in events:
        ...
        if all_events_df is None:
            ...
            all_events_df.append(temp_series)

        print(start, event['summary'])
    all_events_df.to_string
